...
val all : ?folding_csts:constant list option -> variable -> formula -> formula

val exists :
  ?folding_csts:constant list option -> variable -> formula -> formula
...
val all_many :
  ?folding_csts:constant list option -> variable list -> formula -> formula
